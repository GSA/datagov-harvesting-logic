...
def upgrade():
    ...
    with op.batch_alter_table('organization', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_organization_name'), ['name'],
                              unique=False)
    ...
    sa.Column('status', sa.Enum('new', 'in_progress', 'complete', name='job_status'),
              nullable=False),
    ...
    with op.batch_alter_table('harvest_job', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_harvest_job_status'), ['status'],
                              unique=False)
    ...
    sa.Column('severity', sa.Enum('CRITICAL', 'ERROR', 'WARN', name='error_serverity'),
              nullable=False),
    ...
    with op.batch_alter_table('harvest_error', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_harvest_error_severity'), ['severity'],
                              unique=False)
    ...
    with op.batch_alter_table('harvest_record', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_harvest_record_ckan_id'), ['ckan_id'],
                              unique=False)
